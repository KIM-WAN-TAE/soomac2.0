...
#include "dongsoo_interfaces/srv/detail/dong_soo_executor__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dongsoo_interfaces::srv::DongSooExecutor_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dongsoo_interfaces::srv::DongSooExecutor_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dongsoo_interfaces::srv::DongSooExecutor_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DongSooExecutor_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dongsoo_interfaces::srv::DongSooExecutor_Request *>(
...
static size_t _DongSooExecutor_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DongSooExecutor_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DongSooExecutor_Request__callbacks = {
...
static rosidl_message_type_support_t _DongSooExecutor_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DongSooExecutor_Request__callbacks,
...
{
  return &dongsoo_interfaces::srv::typesupport_fastrtps_cpp::_DongSooExecutor_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dongsoo_interfaces::srv::DongSooExecutor_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dongsoo_interfaces::srv::DongSooExecutor_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dongsoo_interfaces::srv::DongSooExecutor_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DongSooExecutor_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dongsoo_interfaces::srv::DongSooExecutor_Response *>(
...
static size_t _DongSooExecutor_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DongSooExecutor_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DongSooExecutor_Response__callbacks = {
  "dongsoo_interfaces::srv",
...
static rosidl_message_type_support_t _DongSooExecutor_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DongSooExecutor_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &dongsoo_interfaces::srv::typesupport_fastrtps_cpp::_DongSooExecutor_Response__handle;
}
...
static service_type_support_callbacks_t _DongSooExecutor__callbacks = {
  "dongsoo_interfaces::srv",
  "DongSooExecutor",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dongsoo_interfaces, srv, DongSooExecutor_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dongsoo_interfaces, srv, DongSooExecutor_Response)(),
...
static rosidl_service_type_support_t _DongSooExecutor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DongSooExecutor__callbacks,
...
{
  return &dongsoo_interfaces::srv::typesupport_fastrtps_cpp::_DongSooExecutor__handle;
}
