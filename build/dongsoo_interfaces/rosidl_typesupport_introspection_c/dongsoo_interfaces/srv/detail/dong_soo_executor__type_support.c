...
static rosidl_typesupport_introspection_c__MessageMember dongsoo_interfaces__srv__DongSooExecutor_Request__rosidl_typesupport_introspection_c__DongSooExecutor_Request_message_member_array[2] = {
  {
    "position",  // name
