...
class MainControlNode(Node):
    ...
    def module_translator(self, ans):
        ...
        if ans.get('camera_tool_up_1_move'):
            ...
            cmd_msg = DongSooCommand()
            cmd_msg.frame = 'l'
            cmd_msg.position = [float(tool_p[0]), float(tool_p[1]) - 0.026, float(tool_p[2]) + 0.09, 0.0]
            cmd_msg.look     = 'straight'
            cmd_msg.time     = 0.8
            cmd_msg.wrist    = tool_yaw
        ...
        if ans.get('camera_tool_up_2_move'):
            ...
            cmd_msg = DongSooCommand()
            cmd_msg.frame = 'l'
            cmd_msg.position = [float(tool_p[0]), float(tool_p[1]) - 0.026, float(tool_p[2]) + 0.105, 0.0]
            cmd_msg.look     = 'straight'
            cmd_msg.time     = 0.8
            cmd_msg.wrist    = tool_yaw
        ...
        if ans.get('camera_tool_up_3_move'):
            ...
            cmd_msg = DongSooCommand()
            cmd_msg.frame = 'l'
            cmd_msg.position = [float(tool_p[0]), float(tool_p[1]) - 0.026, float(tool_p[2]) + 0.1175, 0.0]
            cmd_msg.look     = 'straight'
            cmd_msg.time     = 0.8
            cmd_msg.wrist    = tool_yaw
        ...
        ### =======================================
        ###  BOX Deliver Module =================== 
        if ans.get('camera_box_top_move'):
            with self.lock:
                tool = self.tool
                tool_p = self.tool_p
                tool_yaw = self.tool_yaw
        ...
        if ans.get('camera_box_up_move'):
            ...
            cmd_msg = DongSooCommand()
            cmd_msg.frame = 'l'
            cmd_msg.position = [float(tool_p[0]), float(tool_p[1]), float(tool_p[2]) + 0.12, 0.0]
            cmd_msg.look     = 'down'
            cmd_msg.time     = 3.0
            cmd_msg.wrist    = tool_yaw
        ...
        if ans.get('camera_return_tool_up_move'):
            ...
            cmd_msg = DongSooCommand()
            cmd_msg.frame = 'l'
            cmd_msg.position = [float(tool_p[0]), float(tool_p[1]), 0.28, 0.0]
            cmd_msg.look     = 'down'
            cmd_msg.time     = 3.0
            cmd_msg.wrist    = tool_yaw
        ...
        if ans.get('camera_return_tool_move'):
            ...
            cmd_msg.frame = 'l'
            if tool == 'wire_cutter':
                cmd_msg.position = [float(tool_p[0]) + 0.02 * np.cos(np.deg2rad(tool_yaw)), float(tool_p[1]) + 0.02 * np.sin(np.deg2rad(tool_yaw)), float(tool_p[2]), 0.0]
            elif tool == 'nipper':
