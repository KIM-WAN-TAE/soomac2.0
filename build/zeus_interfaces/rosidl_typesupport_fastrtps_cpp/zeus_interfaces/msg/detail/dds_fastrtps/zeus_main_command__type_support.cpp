...
#include "zeus_interfaces/msg/detail/zeus_main_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const zeus_interfaces::msg::ZeusMainCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zeus_interfaces::msg::ZeusMainCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ZeusMainCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const zeus_interfaces::msg::ZeusMainCommand *>(
...
static size_t _ZeusMainCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ZeusMainCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ZeusMainCommand__callbacks = {
  "zeus_interfaces::msg",
  "ZeusMainCommand",
...
static rosidl_message_type_support_t _ZeusMainCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ZeusMainCommand__callbacks,
...
{
  return &zeus_interfaces::msg::typesupport_fastrtps_cpp::_ZeusMainCommand__handle;
}
