...
static const _ZeusMainCommand_type_support_symbol_names_t _ZeusMainCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zeus_interfaces, msg, ZeusMainCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zeus_interfaces, msg, ZeusMainCommand)),
  }
};
...
{
  return &::zeus_interfaces::msg::rosidl_typesupport_cpp::ZeusMainCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zeus_interfaces, msg, ZeusMainCommand)() {
  return get_message_type_support_handle<zeus_interfaces::msg::ZeusMainCommand>();
}
