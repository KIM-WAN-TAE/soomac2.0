...
{
  /* NOTE(esteve): Call constructor of ZeusExecutor_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("zeus_interfaces.srv._zeus_executor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ZeusExecutor_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool zeus_interfaces__srv__zeus_executor__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zeus_interfaces.srv._zeus_executor.ZeusExecutor_Response", full_classname_dest, 56) == 0);
  }
  zeus_interfaces__srv__ZeusExecutor_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of ZeusExecutor_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("zeus_interfaces.srv._zeus_executor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ZeusExecutor_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
