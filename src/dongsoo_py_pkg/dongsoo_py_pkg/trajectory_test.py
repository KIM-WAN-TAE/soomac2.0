...
class TrajectoryTestNode(Node):
    ...
    시작점: [2048.0, 2048.0, 2048.0, 2048.0] (4자유도)
    종료점: [2048.0, 1800.0, 1800.0, 1800.0] (4자유도)
    """
    ...
    def __init__(self):
        ...
        # 4자유도 궤적 정의: start -> 경유지 -> start
        self.start_pos = [2048.0, 2048.0, 2048.0, 2048.0]  # 시작점 (고정)
        
        # 경유지 위치 (사용자가 수정 가능)
        self.waypoint = [2048.0, 2780.0, 500.0, 1800.0]  # 2,3,4축 소폭 움직임
