...
from dongsoo_control_pkg.read_json import CameraDH, GripperDH
...
class DataHub(Node):
    def __init__(self):
        ...
        self.camera_mat_pub = self.create_publisher(Float32MultiArray, '/aiot/matrix/camera', 10)
        self.gripper_mat_pub = self.create_publisher(Float32MultiArray, '/aiot/matrix/gripper', 10)
