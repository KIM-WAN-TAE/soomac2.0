...
static const _DongSooCommand_type_support_symbol_names_t _DongSooCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dongsoo_interfaces, msg, DongSooCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dongsoo_interfaces, msg, DongSooCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dongsoo_interfaces, msg, DongSooCommand)() {
  return &::dongsoo_interfaces::msg::rosidl_typesupport_c::DongSooCommand_message_type_support_handle;
}
